  ...
  return (
    <aside className="exam-sidebar-card">
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.6rem" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "0.35rem", fontWeight: 800, fontSize: "0.88rem" }}>
      ...
      {/* Progress Bar */}
      <div style={{ width: "100%", height: "5px", background: "#f1f5f9", borderRadius: "3px", overflow: "hidden", marginBottom: "0.75rem" }}>
        <div
          style={{
      ...
      {/* Legend */}
      <div style={{ display: "flex", justifyContent: "space-between", fontSize: "0.7rem", color: "var(--text-muted)", marginBottom: "0.75rem", paddingBottom: "0.45rem", borderBottom: "1px solid var(--border-light)" }}>
        <span style={{ display: "flex", alignItems: "center", gap: "4px" }}>
          <span style={{ width: "7px", height: "7px", borderRadius: "50%", background: "var(--brand-emerald)", display: "inline-block" }} /> Đã làm
        </span>
        <span style={{ display: "flex", alignItems: "center", gap: "4px" }}>
          <span style={{ width: "7px", height: "7px", borderRadius: "50%", background: "#cbd5e1", display: "inline-block" }} /> Chưa làm
        </span>
        <span style={{ display: "flex", alignItems: "center", gap: "4px" }}>
          <span style={{ width: "7px", height: "7px", borderRadius: "50%", background: "var(--brand-primary)", display: "inline-block" }} /> Đang xem
        </span>
      </div>
      ...
      {practicals.length > 0 && (
        <div style={{ marginTop: "0.85rem", paddingTop: "0.65rem", borderTop: "1px solid var(--border-light)" }}>
